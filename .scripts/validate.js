...
const schemasWithOptionalTypeSpecifier = [
	...
	'https://data.landsofhope.com/schemas/v1/races/race-evolution-requirements.json',
	'https://data.landsofhope.com/schemas/v1/professions/profession-evolution-requirements.json',
	...
	'https://data.landsofhope.com/schemas/v1/search/integer-range-condition.json',
	'https://data.landsofhope.com/schemas/v1/search/string-match-condition.json',
	...
	'https://data.landsofhope.com/schemas/v1/characters/search/character-search-skills-condition.json',
	'https://data.landsofhope.com/schemas/v1/characters/search/character-search-skill-condition.json',
	'https://data.landsofhope.com/schemas/v1/characters/search/character-search-properties-condition.json',
	'https://data.landsofhope.com/schemas/v1/characters/search/character-search-property-condition.json',
	'https://data.landsofhope.com/schemas/v1/characters/search/character-search-status-condition.json',
...
const main = async () =>
	await Promise.all([
		...
		validateAll(
			'schemas/v1/items/card-type.json',
			'items/cards/types/!(*.gen).json',
		),
